package org.example.lesson8.step5;

import java.time.LocalDateTime;

public class PalindromValidator implements Validator {
    /**
     * Метод проверяет является ли строка палиндромом и пишет лог.
     */
    @Override
    ...
    /**
     * Метод выводит сообщение в консоль с датой, временем и уровнем лога.
     */
    @Override
